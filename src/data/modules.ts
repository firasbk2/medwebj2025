    ...
    tree: [
      {
        ...
        children: [
          ...
          { label: "Rayonnement", isFileLevel: true },
        ],
      },
      { label: "TD", isFileLevel: true },
      { label: "TP", isFileLevel: true },
    ...
    tree: [
      {
        label: "Cours",
        children: [
          { label: "Intro", isFileLevel: true },
          { label: "Les épithéliums", isFileLevel: true },
          { label: "Tissu conjonctif", isFileLevel: true },
          { label: "Tissu adipeux", isFileLevel: true },
          { label: "Tissu sanguin", isFileLevel: true },
          { label: "Tissu cartilagineux", isFileLevel: true },
          { label: "Tissu osseux", isFileLevel: true },
          { label: "Tissu musculaire", isFileLevel: true },
          { label: "Tissu nerveux", isFileLevel: true },
        ],
      },
      { label: "TP", isFileLevel: true },
    ],
